...
% Inputs ******************************************************************
diameter     = 0.0008;
path_inputs  = '/scratch365/cgonza13/Paper_II/rhop_1161';
path_outputs = '/scratch365/cgonza13/Upscaling_models/Results/AR_v2/rhop_1161';
path_model   = '/scratch365/cgonza13/Upscaling_models/model_AR_v2/AR';
direction    = 'x';
upmean       = 0.020402462660776;
...
% Call function ***********************************************************
disp('Calling AR model...')
addpath(path_model)
tic
[t,xp_mean,xp_var,xp_skew,xp_kur,BTC] = model_AR(time_end,dt_ups,K,rho,xi,pdf_xi,diameter,up,hist_up);
