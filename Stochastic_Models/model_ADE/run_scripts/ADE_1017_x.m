...
path_outputs = '/scratch365/cgonza13/Upscaling_models/Results/ADE/rhop_1017';
path_model   = '/scratch365/cgonza13/Upscaling_models/model_ADE/ADE';
dx           = 0.1*diameter;
% *************************************************************************
...
% Call function ***********************************************************
disp('Calling ADE model...')
addpath(path_model)
tic
[time_ADE,meanpos_ADE,varpos_ADE,skew_ADE,kur_ADE,BTCs,D_coef] = model_ADE(time,meanpos,varpos,diameter,dx);
